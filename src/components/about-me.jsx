...
export default function AboutMe({ className }) {
  ...
  const aboutText = `
    ...
    בשנה שעברה עברתי לבודפשט למשך תקופה, שם שיניתי את אורח חיי, האמונות והערכים שלי מקצה לקצה. האתגר הגדול ביותר שלקחתי על עצמי היה לשפר את יכולות התקשורת שלי, במיוחד עם נשים, ולשחרר את העצמי האותנטי שלי לעולם.
