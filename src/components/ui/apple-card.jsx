  ...
  const cards = [
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">
          כדי להגיע לכך הוא חייב קודם כל לשרת את עצמו , להישאר בנאמנות עצמית ומיקוד פנים כדי שהוא יכול להיות הגרסה הכי טובה של עצמו כדי שיוכל לעזור לאחרים גם להיות כאלה.
          </p>
        </>
      )
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">
            הבעיה העיקרית של גברים עם נשים היא לא חוסר היכולת לגשת ולתקשר , מבוכה ראשונית משיחות עם נשים והצגת כוונה עוברות אחרי זמן קצר של תרגולמה גם שמרבית האינטרקציות כיום מתבצעות באונליין לכן פחד גישה כבר לא מהווה מכשול גדול כמו בעבר.
          </p>
          <p className="mb-4">
            אומנם המכשול העיקרי שהיה ותמיד יהיה הוא חוסר ההבנה המלא של המין הנשי. איך הן פועלות, מה המניעים הרגשיים שמפעילים אותן.
          </p>
          <p className="mb-4">
            אותה ההליכה אל גוב האריות, ללא ידע מקדים על המין המסתורי, הוא שמעכב גברים רבים ולאחר מכן גם מה שמפרק מערכות יחסים.
            כאשר לומדים לעומק כיצד נשים חושבות, מבינים שהמערכת שלהן פועלת באופן דומה ללא קשר למראה החיצוני שלהן.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            לאחר שנפטרת מהאמונות המעכבות ואימצת את "הוראות ההפעלה" של המוח הנשי, כל שנותר לך הוא לאמץ אמונות חדשות ומעצימות שיהפכו אותך לזכר מושך, חזק מנטלית ובעל ערכים.
          </p>
        </>
      )
    },
