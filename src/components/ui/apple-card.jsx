  ...
  const cards = [
    ...
    },
    {
      ...
      content: (
        <>
          <p className="mb-4">
            המכשול העיקרי שהיה ותמיד יהיה עם נשים הוא חוסר ההבנה הכללית של הפסיכולגיה
            הנשית. איך הן פועלות, ומה המניעים הרגשיים שמפעילים אותן. כל אותם המקרים שחוזרים
            על עצמם ומשאירים אותך מתוכסל:
            <br/>
            - דחיות חוזרות במעודנים ובברים
            <br/>
            - גברים &quot;חלאות&quot; שממשיכים להחליף בחורות כאילו כלום
            <br/>
            - דייט שהלך טוב אבל קיבל תפנית שהבחורה לא חזרה אלייך
            <br/>
            - הבחורה מהעבודה/לימודים שמשחקת איתך חם קר וזה לא מתקדם...
            <br/>
            <br/>
            במקום להתמקד בתוכן הדברים שהיא אומרת צריך להבין את המבנה &quot;אל תקשיב למה
            שהיא אומרת, תסתכל על מה שהיא עושה.&quot; – כך ניתן להבין כיצד פועלים עקרונות המשיכה
            והפיתוי, איך לגרום לאישה לרצות אותך , ואיך לגרום לה לחשוב עליך בעדיפות על פני שאר
            הגברים...
            העובדה הפשוטה היא שנשים תמיד יבחנו אותך כגבר - אין בזה שום דבר אישי... וזאת
            הסיבה שאתה חייב להיות מודע לזה ולהבין איך לצלוח את המבחנים האלה כי כשאתה לא
            מבין אותם אתה נופל בהם שוב ושוב והבחורה מאבדת בך אמון בהדרגה.
            ברגע שאתה מבין נשים, אתה משחרר את כל האמונות המעכבות שלך על עצמך ולמה אתה
            &quot;לא טוב עם נשים&quot;. אתה לומד להתמקד במה שקורה בראש שלה במקום במה שקורה
            בראש שלך ובדיאולג הפנימי האינסופי שלך..
          </p>
          <p className="mb-4">
            המכשול העיקרי שהיה ותמיד יהיה עם נשים הוא חוסר ההבנה הכללית של הפסיכולגיה הנשית. איך הן פועלות, ומה המניעים הרגשיים שמפעילים אותן.
            כל אותם המקרים שחוזרים על עצמם ומשאירים אותך מתוכסל:
          </p>
          <ul className="list-disc list-inside mb-4 ml-4">
            <li>דחיות חוזרות במעודנים ובברים</li>
            <li>דייט שהלך טוב אבל התהפך אחרי שהבחורה פשוט נעלמה והתרחקה רגשית</li>
            <li>הבחורה מהעבודה שבקטע שלך אבל זה לא מתקדם - רוצה ואז לא רוצה אותך</li>
            <li>משיכה והערצה בתחילת קשר שמתחלפים בחוסר עניין וזלזול בהמשך</li>
            <li>גברים מניאקים שלא סופרים אף אחד ממשיכים להחליף בחורות כאילו כלום.</li>
          </ul>
          <p className="mb-4">
            העובדה הפשוטה היא שנשים תמיד יבחנו אותך כגבר אין בזה שום דבר אישי אבל אתה חייב להיות מודע לזה ולהבין איך לצלוח את המבחנים האלה כי כשאתה לא מבין אותם אתה נופל בהם והבחורה מאבדת בך אמון בהדרגה.
          </p>
          <p className="mb-4">
            במקום להתמקד בתוכן הדברים שהיא אומרת צריך להבין את המבנה "אל תקשיב למה שהיא אומרת, תסתכל על מה שהיא עושה." – כך ניתן להבין כיצד פועלים עקרונות המשיכה והפיתוי, ואיך לגרום לאישה לרצות אותך , ולחשוב עליך בעדיפות על פני שאר הגברים.
          </p>
