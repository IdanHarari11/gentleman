      ...
      <div className="flex flex-col-reverse md:flex-row-reverse items-center md:items-start justify-between">
        ...
        <div className="z-10 w-full md:w-2/3 md:pl-8 font-rubik">
          ...
          <div className="text-base sm:text-lg md:text-lg text-[#343432] space-y-2 md:space-y-6 leading-relaxed">
            ...
            השנה 2025 ימי הביינים והאצולה מאחורינו והמילה גנטלמן היא עדיין בעלת חשיבות וערך גבוהה מאוד אבל לא מספיק מדוברת או לא מפותחת מעבר לתיאור השטחי שלה של לפתוח דלת למישהי או להביא לה מעיל כשקר לה והאמת שגם די הגיע הזמן שמישהו יעשה לה עדכון גרסה
            שתיהיה רלוונטית לשנה הנוכחית
            </p>
          </div>
        </div>
      </div>
